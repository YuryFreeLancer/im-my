...
class DeleteController extends BaseAdmin
{
    ...
    protected  function  inputData()
    {
        ...
        if (!empty($this->parametrs[$this->table])){
                        ...
                        foreach ($files as $file){
                            ...
                            foreach ($settings::get('templateArr')[$file] as $item){
                                ...
                                if (!empty($this->data[$item])){
                                    ...
                                    $fileData = json_decode($this->data[$item], true) ?: $this->data[$item];  // Сокращенный синтаксис if();
    ...
    protected  function checkDeleteFile()
    {
        ...
        unset($this->parametrs[$this->table]);

        $updateFlag = false;

        foreach ($this->parametrs as $row => $item){
